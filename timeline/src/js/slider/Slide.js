...
export class Slide {
    ...
    updateDisplay(width, height, layout) {
        ...
        this._el.content.style.width = "100%";
    ...
    _positionDateInline() {
        const headline = this._el.content.querySelector('.tl-headline');
        const date = this._el.content.querySelector('.tl-headline-date');
        if (headline && date && headline.nextSibling !== date) {
            headline.parentNode.insertBefore(date, headline.nextSibling);
        }
    }
}
